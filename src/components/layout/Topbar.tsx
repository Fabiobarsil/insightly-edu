...
const Topbar = (_: TopbarProps) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/60 px-4 lg:px-6 py-2 flex items-center justify-between gap-3">
